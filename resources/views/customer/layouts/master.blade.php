                    ...
                    <div class="d-flex m-3 me-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle my-auto mt-2" data-bs-toggle="dropdown">
                                <img src=" {{ asset(Auth::user()->profile ? 'profileImages/' . Auth::user()->profile : 'defaultImage/profileImg.png') }} "
                            ...
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                ...
                                <a href="{{ route('user#navigateChangePassword') }}" class="dropdown-item my-2">Change
                                    Password</a>
